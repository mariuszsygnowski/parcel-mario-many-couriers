module.exports = {
  ...
  courierNameP4D: courier_name => {
    ...
    if (courier_name === 'Express Sameday Collect' || courier_name === 'UPS Express') {
      output = 'UPS';
    }
  ...
  courierName: (courier_name, courier) => {
    ...
    if (courier_name === 'DHL' || courier_name === 'DHL Parcel UK' || courier_name === 'DHL Parcel UK') {
      output = 'DHL';
    }
    if (output === '') {
  ...
  serviceName: (serviceName, courier) => {
    ...
    if (serviceName === 'Service: access point™ to access point™' || serviceName === 'Access Point™ to Access Point™') {
    ...
    if (serviceName === 'Parcelforce Worldwide Express 24 Drop Off' || serviceName === 'ukparcels_podopf24') {
    ...
    if (serviceName === 'Parcelforce Worldwide Express 48 Drop Off' || serviceName === 'ukparcels_podopf48') {
    ...
    if (serviceName === 'Parcelforce Worldwide by 9am' || serviceName === 'ukparcels_pf24before0900') {
    ...
    if (serviceName === 'Parcelforce Worldwide by 10am' || serviceName === 'ukparcels_pf24before1000') {
    ...
    if (serviceName === 'Parcelforce Worldwide Large 48' || serviceName === 'Parcelforce Large') {
    ...
    if (
      ...
      serviceName === 'Hermes ParcelShop Next Day'
    ) {
    ...
    if (serviceName === 'UPS Standard®' || serviceName === 'UPS Express' || serviceName === 'Next Day') {
      output = 'UPS Standard';
    }
    ...
    if (serviceName === 'ukparcels_UKMailDomestic_NextDay0900' || serviceName === 'DHL Express PRE 9AM') {
